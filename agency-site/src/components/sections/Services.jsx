            ...
            return (
              <AnimatedSection key={i} delay={i * 0.15} direction={i === 0 ? 'left' : i === 2 ? 'right' : 'up'}>
                <TiltCard className="h-full">
                  <div className="group bg-[#16161f] border border-white/[0.08] rounded-2xl p-7 h-full hover:border-indigo-500/40 transition-all duration-300 hover:shadow-[0_0_40px_rgba(99,102,241,0.06)]">
